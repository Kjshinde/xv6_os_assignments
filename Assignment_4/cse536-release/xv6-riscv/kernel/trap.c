  ...
  p->trapframe->epc = r_sepc();
   ...
   if(r_scause() == CAUSE_SYSCALL_ECALL){
    ...
    // ok
            ...
            r_scause() != CAUSE_STORE_PAGE_FAULT) {
      // Handle other privileged instructions for VM processes
      // Exclude page faults from trap-and-emulate
      trap_and_emulate();
    }
    else {
